...
class Tacotron2Logger(SummaryWriter):
    ...
    def log_synth_dict(self, synth_dict, synth_dict_type,
        ...
        wandb.log({
            ...
            "{}/teacher_forcing/attention_ratio": synth_dict['ar_tf'],
            "{}/teacher_forcing/letter_attention_ratio": synth_dict['letter_ar_tf'],
            "{}/teacher_forcing/punctuation_attention_ratio": synth_dict['punct_ar_tf'],
            "{}/teacher_forcing/blank_attention_ratio": synth_dict['blank_ar_tf'],
            "{}/teacher_forcing/attention_range_ratio": synth_dict['arr_tf'],
            "{}/teacher_forcing/multiple_attention_ratio": synth_dict['mar_tf'],
            ...
            "{}/free_running/attention_ratio": synth_dict['ar_fr'],
            "{}/free_running/letter_attention_ratio": synth_dict['letter_ar_fr'],
            "{}/free_running/punctuation_attention_ratio": synth_dict['punct_ar_fr'],
            "{}/free_running/blank_attention_ratio": synth_dict['blank_ar_fr'],
            "{}/free_running/attention_range_ratio": synth_dict['arr_fr'],
            "{}/free_running/multiple_attention_ratio": synth_dict['mar_fr'],
        }, step=iteration)
